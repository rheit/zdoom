...
enum
{
	...
	COMPATF2_REVIVEGIBS		= 1 << 3,	// Let Arch Viles revive gibbed corpses
	COMPATF2_REVIVEGHOSTS	= 1 << 4,	// Revive gibs as ghosts
	COMPATF2_REVIVE			= COMPATF2_REVIVEGIBS|COMPATF2_REVIVEGHOSTS,
};
